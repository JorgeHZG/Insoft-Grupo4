 ...
 */
public class OcupacionAdminServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public OcupacionAdminServlet() {
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			request.getRequestDispatcher("EstadisticasAdmin.jsp").forward(request, response);
